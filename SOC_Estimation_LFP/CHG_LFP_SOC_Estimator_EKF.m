%% Main Part of SOC Estimator by EKF. This Code Estimates SOC in the Usable Range
...
for k = 1 : Nsamples
    if Init_Flag == 0
        ...
        Estimation(k, :) = [Cell_Data.SOC_Initial Cell_Data.V1_Initial];    % Assign Initial State Variable Value
